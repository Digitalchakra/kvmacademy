<?php
/**
 * @version		$Id: category.php 802 2011-04-29 10:45:10Z lefteris.kavadas $
 * @package		K2
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if($name=='categories' || $name=='jform[params][categories]'){
			...
			function disableParams(){
				...
				$('paramsfeedLink0').setProperty('disabled','disabled');
				$('paramsfeedLink1').setProperty('disabled','disabled');
			...
			function enableParams(){
				...
				$('paramsfeedLink0').removeProperty('disabled');
				$('paramsfeedLink1').removeProperty('disabled');
			...
			if(K2_JVERSION == '16') {
				...
				function disableParams(){
					...
					$('jform_params_feedLink0').setProperty('disabled','disabled');
					$('jform_params_feedLink1').setProperty('disabled','disabled');
				...
				function enableParams(){
					...
					$('jform_params_feedLink0').removeProperty('disabled');
					$('jform_params_feedLink1').removeProperty('disabled');
