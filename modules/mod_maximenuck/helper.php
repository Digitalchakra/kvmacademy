...
class modMaximenuckHelper {
     ...
     * @return Array
     */
    static function createCss($menuID, $params, $prefix = 'menu') {
...
//                . "filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='" . $params->get($prefix . 'bgcolor1', '#f0f0f0') . "', endColorstr='" . $params->get($prefix . 'bgcolor2', '#e3e3e3') . "',GradientType=0 );" : '';
        $css['borderradius'] = ($params->get($prefix . 'useroundedcorners')) ?
                '-moz-border-radius: ' . self::testUnit($params->get($prefix . 'roundedcornerstl', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornerstr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbl', '0')) . ';'
                . '-webkit-border-radius: ' . self::testUnit($params->get($prefix . 'roundedcornerstl', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornerstr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbl', '0')) . ';'
                . 'border-radius: ' . self::testUnit($params->get($prefix . 'roundedcornerstl', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornerstr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbr', '0')) . ' ' . self::testUnit($params->get($prefix . 'roundedcornersbl', '0')) . ';' : '';
        ...
        $css['shadow'] = ($params->get($prefix . 'shadowcolor') AND $params->get($prefix . 'shadowblur') AND $params->get($prefix . 'useshadow')) ?
                '-moz-box-shadow: ' . $shadowinset . self::testUnit($params->get($prefix . 'shadowoffsetx', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowoffsety', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowblur', '')) . ' ' . self::testUnit($params->get($prefix . 'shadowspread', '0')) . ' ' . $params->get($prefix . 'shadowcolor', '') . ';'
                . '-webkit-box-shadow: ' . $shadowinset . self::testUnit($params->get($prefix . 'shadowoffsetx', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowoffsety', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowblur', '')) . ' ' . self::testUnit($params->get($prefix . 'shadowspread', '0')) . ' ' . $params->get($prefix . 'shadowcolor', '') . ';'
                . 'box-shadow: ' . $shadowinset . self::testUnit($params->get($prefix . 'shadowoffsetx', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowoffsety', '0')) . ' ' . self::testUnit($params->get($prefix . 'shadowblur', '')) . ' ' . self::testUnit($params->get($prefix . 'shadowspread', '0')) . ' ' . $params->get($prefix . 'shadowcolor', '') . ';' : '';
        $css['border'] = ($params->get($prefix . 'bordercolor') AND $params->get($prefix . 'useborders')) ?
                'border: ' . $params->get($prefix . 'bordercolor', '#efefef') . ' ' . self::testUnit($params->get($prefix . 'borderwidth', '1')) . ' solid;' :
                 (($params->get($prefix . 'borderwidth') == '0' AND $params->get($prefix . 'useborders')) ? 'border: none;' : '');
        $css['fontsize'] = ($params->get($prefix . 'usefont') AND $params->get($prefix . 'fontsize')) ?
                'font-size: ' . self::testUnit($params->get($prefix . 'fontsize')) . ';' : '';
        ...
        $css['textshadow'] = ($params->get($prefix . 'textshadowcolor') AND $params->get($prefix . 'textshadowblur') AND $params->get($prefix . 'usetextshadow')) ?
                'text-shadow: ' . $textshadowoffsetx . ' ' . $textshadowoffsety . ' ' . self::testUnit($params->get($prefix . 'textshadowblur', '')) . ' ' . $params->get($prefix . 'textshadowcolor', '') . ';' :
                (($params->get($prefix . 'textshadowblur') == '0' AND $params->get($prefix . 'usetextshadow')) ? 'text-shadow: none;' : '');
    ...
    static function injectItemCss($item, $menuID) {
        $itemcss = '';
        $cssitemnormal = self::createCss($menuID, $item->params, 'itemnormalstyles');
        $cssitemhover = self::createCss($menuID, $item->params, 'itemhoverstyles');
        $cssitemactive = self::createCss($menuID, $item->params, 'itemactivestyles');
        $csssubmenu = self::createCss($menuID, $item->params, 'submenustyles');
...
//            var_dump($fields);
        ...
        if (isset($css->level2itemactivestyles)) {
            ...
            if ($css->level2itemhoverstyles['fontcolor']
                ...
                $csstoinject .= "\ndiv#" . $menuID . " ul.maximenuck li.maximenuck.level1 li.maximenuck.active > a span.titreck, div#" . $menuID . " ul.maximenuck li.maximenuck > span.separator span.titreck { " . $css->level2itemactivestyles['fontcolor'] . $css->level2itemactivestyles['fontsize'] . $css->level2itemactivestyles['fontweight'] . $css->level2itemhoverstyles['textshadow'] . " } ";
            }
            if ($css->level2itemhoverstyles['fontcolor']
                    || $css->level2itemhoverstyles['fontsize']
            ) {
                $csstoinject .= "\ndiv#" . $menuID . " ul.maximenuck li.maximenuck.level1 li.maximenuck.active > a span.descck, div#" . $menuID . " ul.maximenuck li.maximenuck > span.separator span.descck { " . $css->level2itemactivestyles['descfontcolor'] . $css->level2itemactivestyles['descfontsize'] . $css->level2itemhoverstyles['textshadow'] . " } ";
            }
        }

        // var_dump($css->level1itemnormalstyles);
        if ($csstoinject)
