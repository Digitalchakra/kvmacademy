	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
                ...
                <li>
                    <label><?php echo JText::_('Fields Group');?></label>
                    <div id="tz_fields_group"><?php echo $this -> listsGroup;?></div>
                </li>
                <li>
                    <?php echo $this -> form -> getLabel('type_of_media');?>
<!--                    <label title="--><?php //echo JText::_('COM_TZ_PORTFOLIO_TYPE_OF_MEDIA_DESC');?><!--">-->
