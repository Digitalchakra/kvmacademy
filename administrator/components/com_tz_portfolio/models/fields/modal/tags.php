...
class JFormFieldModal_Tags extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('COM_TZ_PORTFOLIO_SELECT_TAGS_BUTTON').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_TZ_PORTFOLIO_SELECT_TAGS_BUTTON').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
