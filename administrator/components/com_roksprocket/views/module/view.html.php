...
class RokSprocketViewModule extends RokSprocketLegacyJView
{
	...
	protected function compileLess()
	{
		...
		RokCommon_Header::addStyle(JURI::base(true) . '/components/com_roksprocket/assets/styles/roksprocket.css?nocache=1.8.2');
	}
	...
	protected function compileJS()
	{
		...
		RokCommon_Header::addScript(JURI::base(true) . '/components/com_roksprocket/assets/js/roksprocket.js?nocache=1.8.2');
