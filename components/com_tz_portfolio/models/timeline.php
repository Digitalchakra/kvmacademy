...
class TZ_PortfolioModelTimeLine extends JModel
{
    ...
    function ajax(){
        ...
        require_once JPATH_COMPONENT.DS.'views'.DS.'timeline'.DS.'view.html.php';
    ...
    function ajaxtags($limitstart=null) {
        ...
        require_once JPATH_COMPONENT.DS.'views'.DS.'portfolio'.DS.'view.html.php';
    ...
    function getArticle(){
        ...
        if($rows   = $db -> loadObjectList()){
            foreach($rows as $i => $item){
                ...
                if($model  = &JModel::getInstance('Media','TZ_PortfolioModel')){
                    if($media  = $model -> getMedia($item -> id)){
                        ...
                        if($media[0] -> type != 'video'){
                            ...
                            if(!empty($media[0] -> images)){
                                ...
                                $item -> tz_image       = JURI::root().'components/com_tz_portfolio/assets/no_image.png';
                            }
                        }
                        else{
                        ...
                        $item -> tz_image       = JURI::root().'components'
                                                  .'/com_tz_portfolio/assets/no_image.png';
                    }
                }
