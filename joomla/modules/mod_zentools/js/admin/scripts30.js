...
jQuery(function() {
	...
	imagedirectory = "li a[href=#options-imageDirectory]";
	pagination= "li a[href=#options-pagination]";
	twitterPanel = "li a[href=#options-twitter]";

	imageSource = "#jform_params_contentSource0";
	k2Source = "#jform_params_contentSource2";
	joomlaSource = "#jform_params_contentSource1";
	...
	{
		if (jQuery(imageSource).attr('checked'))
		{
	...
	var tmp = imageSourceFor = imageSource.replace('#', '').replace('0', '');
	jQuery('label[for^="'+imageSourceFor+'"]').click(setContentSource);
	setContentSource();
	...
	if (jQuery('#jform_params_k2contentSource0').is(':checked')) {
	...
	if (jQuery('#jform_params_joomlaContentSource0').is(':checked')) {
	...
	jQuery('#jform_params_joomlaContentSource label').click(function() {
		// Toggle for Joomla content source
		if (jQuery('#jform_params_joomlaContentSource0').is(':checked')) {
			jQuery("#jform_params_artids").parent().parent().hide();
			jQuery("#jform_params_catid").parent().parent().show();
	...
	jQuery('#jform_params_k2contentSource label').click(function() {
		// Toggle for k2 content source
		if (jQuery('#jform_params_k2contentSource0').is(':checked')) {
			jQuery("#jform_params_itemid").parent().parent().hide();
			jQuery("#jform_params_category_id,#jform_params_category_id-lbl,#jform_params_getChildren,#jform_params_getChildren-lbl").parent().parent().show();
