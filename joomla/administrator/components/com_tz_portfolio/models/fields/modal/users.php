...
class JFormFieldModal_Users extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('JLIB_FORM_CHANGE_USER').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('JLIB_FORM_CHANGE_USER').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
