...
if (strlen($article->created))
    $params['metadata-header-icons'][] = "<span class=\"kvm-postdateicon\">" . $article->createdDateInfo($article->created) . "</span>";
if (strlen($article->modified))
    $params['metadata-header-icons'][] = "<span class=\"kvm-postdateicon\">" . $article->modifiedDateInfo($article->modified) . "</span>";
if (strlen($article->published))
    $params['metadata-header-icons'][] = "<span class=\"kvm-postdateicon\">" . $article->publishedDateInfo($article->published) . "</span>";
if (strlen($article->author))
    $params['metadata-header-icons'][] = "<span class=\"kvm-postauthoricon\">" . $article->authorInfo($article->author, $article->authorLink) . "</span>";
...
if (strlen($article->category))
    $params['metadata-footer-icons'][] = "<span class=\"kvm-postcategoryicon\">"
