...
class JElementZeninfo extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name)
	{
		...
		if ($zgfEnabled) {
				...
				// Include zen grid
				?>
				<div class="links"><h4>Active css for your template</h4><a href="<?php echo JURI::root() ?>/templates/<?php echo $template; ?>/css/theme.css" class="modal positions" rel="{handler: 'iframe', size: {x: 700, y: 600}}">Theme CSS</a><a href="<?php echo JURI::root() ?>/templates/<?php echo $template; ?>/css/<?php echo $hilite ?>.css" class="modal positions" rel="{handler: 'iframe', size: {x: 700, y: 600}}"><?php echo $hilite ?> CSS</a></div>
				<?php
					return ob_get_clean();
