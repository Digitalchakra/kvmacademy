...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<fieldset class="word" style = "height:40px; padding:10px;">
	...
	<div class="searchintro<?php echo $this->params->get('pageclass_sfx'); ?>">
		...
		<p><h3>Showing Results for <?php echo $this->escape($this->origkeyword); ?>; Total Found: <?php echo ($this->total);?></h3></p>
		<?php endif;?>
	</div>
...
<div style = "float:left; width:258px;margin-left:10px;padding-bottom:20px;">
...
<div style = "float:left; width:258px; margin-left:50px;">	
        <fieldset class="only">
