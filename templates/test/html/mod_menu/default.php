...
if (isset($attribs['name']) && $attribs['name'] == 'position-1') {
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'kvm-vmenu') || false !== strpos($params->get('moduleclass_sfx'), ' kvm-vmenu')) {
    $menutype = 'vertical';
