...
function modChrome_artstyle($module, &$params, &$attribs)
{
  ...
  //  'kvm-...'        - overwrites module style.
  //  'kvm-... suffix' - overwrites style and adds suffix to the module root tag and
  //                     to the module elements, does not add kvm-... to the module elements.
  $classes = '';
...
<div class="kvm-nostyle<?php echo $params->get('artx-module-classes'); ?>">
